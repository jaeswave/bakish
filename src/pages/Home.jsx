...
import { default as heroImage } from '/images/agbada.png'; // Make sure this path corresponds to public folder or assets
        ...
        <div className="w-full">
            ...
            <section className="py-16 md:py-24 bg-[#0a0a0a] border-t border-brand-brown/10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-4xl md:text-5xl text-white">Featured Collections</h2>
            ...
            <section className="py-16 md:py-24 bg-[#050505]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center">
                        ...
                        >
                            <div>
                                <span className="text-brand-gold uppercase tracking-[0.2em] text-sm font-semibold mb-2 block">Our Story</span>
                                <h2 className="text-4xl md:text-5xl leading-tight text-white mb-6">The Art of <br />Premium Tailoring</h2>
                                <div className="w-16 h-1 bg-brand-gold"></div>
                            </div>
                            <p className="text-brand-cream/70 text-lg leading-relaxed">
                                Bakish Wears is more than a fashion brand; it's a statement of royalty, culture, and modern African elegance. Every stitch tells a story of luxury craftsmanship designed to bring out the confidence in you.
                            </p>
                            <p className="text-brand-cream/70 text-lg leading-relaxed pb-4">
                                Whether you are a groom, a business leader, or a diaspora African maintaining roots, our bespoke Agbada, Senator wears, and Kaftans are tailored to perfection.
                            </p>
            ...
            <section className="py-16 md:py-24 bg-brand-black relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl md:text-5xl text-white">Words of Royalty</h2>
                        <div className="w-24 h-1 bg-brand-gold mx-auto mt-6"></div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                        {[
                            ...
                            >
                                <div className="text-brand-gold text-4xl font-serif absolute top-4 left-6 opacity-20">"</div>
                                <p className="text-brand-cream/80 text-lg mb-8 relative z-10 italic">"{testimonial.text}"</p>
                                <div>
                                    <h4 className="font-serif text-white text-xl">{testimonial.author}</h4>
                                    <p className="text-brand-gold text-sm tracking-wider uppercase mt-1">{testimonial.location}</p>
                                </div>
                            </motion.div>
                        ))}
                    </div>
            ...
            <section className="py-16 bg-[#050505] border-t border-brand-brown/10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pb-12">
                    <h2 className="font-serif text-3xl text-white mb-4">Follow The Culture</h2>
                    <p className="text-brand-cream/60 mb-8">@bakishwears</p>
                    <div className="flex justify-center flex-wrap gap-4">
                        <img src="/images/agbada.png" alt="Insta 1" className="w-32 h-32 md:w-48 md:h-48 object-cover grayscale hover:grayscale-0 transition-all duration-500" />
                        <img src="/images/senator.png" alt="Insta 2" className="w-32 h-32 md:w-48 md:h-48 object-cover grayscale hover:grayscale-0 transition-all duration-500" />
                        <img src="/images/kaftan.png" alt="Insta 3" className="w-32 h-32 md:w-48 md:h-48 object-cover grayscale hover:grayscale-0 transition-all duration-500" />
                        <img src="/images/wedding.png" alt="Insta 4" className="w-32 h-32 md:w-48 md:h-48 object-cover grayscale hover:grayscale-0 transition-all duration-500 hidden sm:block" />
                    </div>
                    <div className="mt-12">
                        <Button to="#" variant="outline">Follow on Instagram</Button>
                    </div>
                </div>
            </section>
        </div>
