...
const Collections = () => {
    ...
    return (
        <div className="pt-24 min-h-screen bg-brand-black">
            {/* Header */}
            <div className="py-16 md:py-24 text-center bg-[#050505] border-b border-brand-brown/20 bg-[url('/images/agbada.png')] bg-cover bg-center relative bg-blend-overlay">
                <div className="absolute inset-0 bg-brand-black/90"></div>
                <div className="relative z-10 px-4 max-w-4xl mx-auto">
                    <motion.h1
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="text-4xl md:text-5xl lg:text-6xl text-brand-gold mb-4"
                    >
                        The Collection
                    </motion.h1>
                    <motion.p
                ...
                <div className="flex flex-wrap justify-center gap-2 md:gap-4 mb-10 md:mb-16">
                    {categories.map((category) => (
                        <button
                            ...
                            className={`px-4 py-1.5 md:px-6 md:py-2 rounded-full text-xs md:text-sm uppercase tracking-wider font-semibold transition-all duration-300 border ${activeCategory === category
